...
function ShowSubMenu(id) //显示下拉
 {
   ...
   switch(submenu_style)
    {
      case 1:
       document.write('<link rel="stylesheet" type="text/css" href="/static/html/e/css/dropmenu.css" />');
       addHover("Menu","li","hover");
      break;

     case 2:
       document.write('<link rel="stylesheet" type="text/css" href="/static/html/e/css/submenu.css" />');
...
document.write("<script src=\"/static/html/e/js/function.js\" type=\"text/javascript\"></script>");
document.write("<script src=\"/static/html/e/js/dialog.js\" type=\"text/javascript\"></script>");
//document.write("<script src=\"/static/html/e/incs/pie/PIE.js\" type=\"text/javascript\"></script>");